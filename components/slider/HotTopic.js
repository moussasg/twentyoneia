            ...
            <div className="box-topics border-gray-800 bg-gray-850 wow animate__animated animate__fadeInUp">
                <div className="row">
                    <div className="col-lg-2">
                        <h5 className="mb-15 color-white wow animate__animated animate__fadeInUp" data-wow-delay="0s">Strategic Directions</h5>
                        <p className="color-gray-500 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">Don't miss out on the latest news about Ai Tech,
                            Softwares Dev,  guide...</p>
                                ...
                                >
                                    {categories.map((item, i) => (
                                        <SwiperSlide className="swiper-slide" key={i}>
                                            <div className="card-style-1">  <Link href={`/${item.url}`}>
